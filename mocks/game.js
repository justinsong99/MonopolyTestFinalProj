...
function Game() {
	...
	this.setDiceRolledVal = function(ztest) {
		areDiceRolled = ztest
	}

	this.getDiceRolledVal = function() {
		return areDiceRolled
	}

	this.setHighestBidder = function(val) {
		highestbidder =  val
	}

	this.setHighestBid = function(val) {
		highestbid = val
	}
	...
	this.getAuctionQueueLength = function(){
